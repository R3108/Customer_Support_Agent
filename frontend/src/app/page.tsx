  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative overflow-hidden bg-ink-950 text-white">
        ...
        <div className="absolute -top-40 left-1/2 h-[520px] w-[900px] -translate-x-1/2 rounded-full bg-brand-600/30 blur-3xl" />
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 pb-24 pt-12 lg:grid-cols-[1.05fr_1fr] lg:pt-20">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-semibold leading-[1.08] tracking-tight sm:text-5xl lg:text-6xl">
              AI support that knows <span className="bg-gradient-to-r from-brand-300 to-fuchsia-300 bg-clip-text text-transparent">when to hand off.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/demo"
                className="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-5 py-3 font-medium text-white shadow-lg shadow-brand-500/25 hover:bg-brand-400"
              >
          ...
          <div className="relative">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-2 shadow-2xl backdrop-blur">
              <div className="overflow-hidden rounded-xl bg-white text-slate-900">
                ...
                <div className="space-y-3 bg-slate-50 p-4 text-sm">
                  <div className="ml-auto w-fit max-w-[80%] rounded-2xl rounded-br-md bg-brand-600 px-3 py-2 text-white">I want a refund for the kayak I got last week</div>
                  <div className="max-w-[88%] rounded-2xl rounded-bl-md border border-amber-200 bg-white px-3 py-2">
            ...
            <div className="absolute -bottom-16 left-6 hidden rounded-xl border border-white/10 bg-ink-950/90 p-3 text-xs shadow-xl sm:block">
              ...
              <div className="flex items-center gap-1.5 font-mono text-[11px] text-slate-200">
                <span className="rounded bg-white/10 px-1.5 py-0.5">intent</span>→<span className="rounded bg-white/10 px-1.5 py-0.5">retrieve</span>→
                <span className="rounded bg-white/10 px-1.5 py-0.5">support</span>→<span className="rounded bg-amber-500/20 px-1.5 py-0.5 text-amber-200">escalate</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="how" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {AGENTS.map(({ icon: Icon, name, body }, i) => (
            <div key={name} className="relative rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <section className="border-y border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-6 py-24">
          <h2 className="max-w-2xl text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">Everything a support team needs on day one.</h2>
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-3">
          {PLANS.map((p) => (
            <div
              ...
              className={
                p.featured
                  ? "relative rounded-2xl bg-ink-950 p-7 text-white shadow-xl ring-2 ring-brand-500"
